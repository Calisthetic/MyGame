...
function initShot() {
    ...
    buffs.forEach((buff,index) => {
        ...
        if ((cube.y > buff.y && cube.y < buffBottom) || (cubeBottom < buff.y && cubeBottom > buffBottom) || (cube.oldY < cube.y && cube.y > buff.y)) {
            if ((cube.x > buff.x && cube.x < buffRight) || (cubeRight < buff.x && cubeRight > buffRight) || (cube.oldX < cube.x && cube.x > buff.x)) {
                shotBuff(buff);
    ...
    //     (buff.y > cube.oldY + cube.height && buff.y < cube.y + cube.height) || 
    //     (buff.y > cube.y + cube.height && buff.y < cube.oldY + cube.height)) {
